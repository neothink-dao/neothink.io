...
export default function TrendsChart({ initialData, userRole = 'admin' }: TrendsChartProps) {
  const [feedbackTrends, setFeedbackTrends] = useState<FeedbackTrend[]>(initialData);
        ...
        {feedbackTrends.length === 0 ? (
          ...
          <div className="p-4">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {Array.from(new Set(feedbackTrends.map(item => item.user_role))).map(role => (
