...
const PlatformHeaderInner = () => {
  ...
  return (
    <header className="platform-header" style={{ borderColor: platformColor }}>
      <div className="platform-header-left">
        <img 
          src={`/logos/${currentPlatform}-logo.svg`} 
          alt={`${PLATFORM_NAMES[currentPlatform]} Logo`}
...
const PlatformHeader = () => {
  ...
  return (
    <PlatformBridgeProvider userId={userId} initialPlatform="hub">
      <PlatformHeaderInner />
    </PlatformBridgeProvider>
  );
};
