...
export default function UserSearch() {
    ...
    async function handleSearch(e) {
        ...
        try {
            ...
            const { data: badgeEvents } = await supabase
                ...
                .limit(10);
            const allEvents = [
                ...((xpEvents === null || xpEvents === void 0 ? void 0 : xpEvents.map(ev => (Object.assign(Object.assign({}, ev), { table: "xp_events" })))) || []),
                ...((badgeEvents === null || badgeEvents === void 0 ? void 0 : badgeEvents.map(ev => (Object.assign(Object.assign({}, ev), { table: "badge_events" })))) || []),
            ];
    ...
    return (<div className="bg-white rounded-lg shadow p-4 mt-6">
      <h2 className="text-xl font-bold mb-4">User Search</h2>
      <form onSubmit={handleSearch} className="flex gap-2 mb-4">
        <input className="border rounded px-2 py-1 flex-1" type="text" placeholder="Enter user ID..." value={query} onChange={e => setQuery(e.target.value)}/>
      ...
      {events.length > 0 && (<table className="min-w-full text-sm mt-2">
          <thead>
            <tr>
