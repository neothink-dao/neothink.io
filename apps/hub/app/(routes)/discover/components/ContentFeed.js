...
export async function ContentFeed() {
    ...
    return (<div className="space-y-6">
      ...
      <div className="space-y-6">
        {contentItems.map(item => (<Link key={item.id} href={item.url} className="block p-5 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
...
//# sourceMappingURL=ContentFeed.js.map