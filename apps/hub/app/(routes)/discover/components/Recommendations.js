...
export async function Recommendations() {
    ...
    return (<div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-5 space-y-5">
        {recommendedItems.map(item => (<Link key={item.id} href={item.url} className="block bg-white p-4 rounded border border-gray-200 hover:border-blue-300 transition-colors">
        ...
        <Link href="/discover/recommendations" className="block text-center text-blue-600 hover:text-blue-800 font-medium">
