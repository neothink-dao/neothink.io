    ...
    return (<div className="container py-10">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col rounded-lg border p-6">
            ...
            <ul className="mt-6 space-y-3">
              {ascendersFeatures.map((feature) => (<li key={feature} className="flex items-center text-sm">
          ...
          <div className="flex flex-col rounded-lg border p-6">
            ...
            <ul className="mt-6 space-y-3">
              {neothinkersFeatures.map((feature) => (<li key={feature} className="flex items-center text-sm">
                  <Check className="mr-2 h-4 w-4"/>
                  {feature}
                </li>))}
            </ul>
          ...
          <div className="flex flex-col rounded-lg border p-6">
            ...
            <ul className="mt-6 space-y-3">
              {immortalsFeatures.map((feature) => (<li key={feature} className="flex items-center text-sm">
                  <Check className="mr-2 h-4 w-4"/>
                  {feature}
                </li>))}
            </ul>
      ...
      <section className="space-y-6 py-8">
        <div className="rounded-lg border-2 border-primary bg-primary/5 p-8">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <ul className="mt-6 space-y-3">
              {superachieverBenefits.map((benefit) => (<li key={benefit} className="flex items-center text-sm">
      ...
      <section className="space-y-6 py-8">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {faqs.map((faq) => (<div key={faq.question} className="rounded-lg border p-6">
