    ...
    return (<div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <a href="https://neothinkers.neothink.com" className="text-black hover:text-gray-800 font-medium">
            Learn more →
          </a>
        </div>
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <a href="https://ascenders.neothink.com" className="text-black hover:text-gray-800 font-medium">
            Learn more →
          </a>
        </div>
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <a href="https://immortals.neothink.com" className="text-black hover:text-gray-800 font-medium">
            Learn more →
          </a>
        </div>
      </div>
...
export default function DiscoverPage() {
    return (<Suspense fallback={<LoadingState message="Loading discover page..."/>}>
      <DiscoverContent />
    </Suspense>);
}
