      ...
      <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              {visionPoints.map((point, index) => (
                <div key={index} className="flex items-start space-x-3 bg-white bg-opacity-50 p-4 rounded-lg">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {contributions.map(contribution => (
            <div key={contribution.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {insights.map(insight => (
              <div key={insight.id} className="p-6 bg-gray-50 rounded-lg">
