      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex items-center space-x-4 bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex-1 flex items-center space-x-2 px-3 py-2 border rounded-md">
            ...
            <input 
              type="text"
              placeholder="Search neothinkers, discussions, or topics..."
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center space-x-4">
              <Link
                ...
                className="bg-white text-indigo-600 px-6 py-3 rounded-lg border border-indigo-200 hover:border-indigo-300 transition-colors font-medium"
              >
                Start Discussion
              </Link>
              <Link
