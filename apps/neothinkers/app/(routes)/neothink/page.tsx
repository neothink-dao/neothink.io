      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="flex items-center space-x-4 bg-white p-4 rounded-lg border border-gray-200">
          <div className="flex-1 flex items-center space-x-2 px-3 py-2 border rounded-md">
            ...
            <input 
              type="text"
              placeholder="Search concepts, principles, or topics..."
            ...
            <div key={category.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-2">
                {category.topics.map(topic => (
                  <Link
                    key={topic.id}
                    href={`/neothink/${category.slug}/${topic.slug}`}
          ...
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <Link
                  href="/neothink/beginner-path"
                  className="inline-flex items-center mt-4 text-purple-700 font-medium hover:text-purple-800"
                >
