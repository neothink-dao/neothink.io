...
export async function POST(req) {
    try {
        ...
        const baseXP = (metadata === null || metadata === void 0 ? void 0 : metadata.xp_earned) || 10;
        ...
        const xpRes = await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_FUNCTIONS_URL}/log-xp-event`, {
            ...
            body: JSON.stringify({
                user_id: user.id,
                team_id: metadata === null || metadata === void 0 ? void 0 : metadata.team_id,
            ...
            if ((count || 0) === 0) {
                await fetch(`${process.env.NEXT_PUBLIC_SUPABASE_FUNCTIONS_URL}/log-badge-event`, {
                    ...
                    body: JSON.stringify({
                        ...
                        badge_id: badge.id,
                        event_type: 'earned',
                        metadata: Object.assign({ action_type }, metadata),
                    }),
                });
