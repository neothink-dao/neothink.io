...
/**
 * Home page for the Ascenders platform
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Ascenders Platform</h1>
      ...
      {isAdmin && (
        <ErrorBoundary>
          <div className="mt-12">
            ...
            <AnalyticsDashboard initialPlatform="ascenders" days={7} />
          </div>
        </ErrorBoundary>
      )}
    </div>
