...
/**
 * Home page for the Immortals platform
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Immortals Platform</h1>
      ...
      {isAdmin && (
        <ErrorBoundary>
          <div className="mt-12">
            ...
            <AnalyticsDashboard initialPlatform="immortals" days={7} />
          </div>
        </ErrorBoundary>
      )}
    </div>
