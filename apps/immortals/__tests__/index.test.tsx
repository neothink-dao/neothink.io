...
describe('Immortals HomePage', () => {
  ...
  it('renders the page title', () => {
    render(<HomePage />);
    expect(screen.getByText('Immortals Platform')).toBeInTheDocument();
  });

  it('tracks page view on initial render', () => {
    render(<HomePage />);
    expect(analytics.page).toHaveBeenCalledWith('immortals', '/');
  });
  ...
  it('fetches and displays achievements', async () => {
    ...
    expect(mockEq).toHaveBeenCalledWith('platform', 'immortals');
