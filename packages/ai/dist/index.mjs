...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./lib-BJP5VY5W.mjs").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./wrapper-SSF4RXSF.mjs").then(({ default: WS }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./lib-BJP5VY5W.mjs")).Response;
  }
  return Response;
});
...
var SupabaseAI = class {
  constructor(supabaseUrl, supabaseKey, openaiApiKey) {
    this.supabase = createClient(supabaseUrl, supabaseKey);
    this.openai = new OpenAI2({ apiKey: openaiApiKey });
  }
  /**
...
var AIServiceContext = createContext(void 0);
var AIServiceProvider = ({
  ...
  return /* @__PURE__ */ React.createElement(AIServiceContext.Provider, { value }, children);
};
var useAI = () => {
...
var AIChatMessage = ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `ai-chat-message ${isUser ? "user" : "assistant"} ${className}` }, /* @__PURE__ */ React.createElement("div", { className: "ai-chat-message-avatar" }, isUser ? "\u{1F464}" : "\u{1F916}"), /* @__PURE__ */ React.createElement("div", { className: "ai-chat-message-content" }, message));
};
var AIChatInput = ({
  onSend,
  ...
  return /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit, className: `ai-chat-input ${className}` }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: message,
