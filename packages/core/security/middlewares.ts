 ...
 */
function addNonceToCsp(cspObject: Record<string, string[]>, nonce: string) {
  const newCsp = { ...cspObject };
 ...
 */
function cspObjectToString(cspObject: Record<string, string[]>) {
 ...
 */
export async function securityMiddlewareWithRateLimit(req: NextRequest) {
  // Check rate limit
