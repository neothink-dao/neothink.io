...
export class NotificationService {
    ...
    static subscribeToNotifications(userId, platforms, callback) {
        ...
        const channel = this.supabase
            ...
            if (notification.target_platforms &&
                notification.target_platforms.some((p) => platforms.includes(p))) {
    ...
    static subscribeToNotificationsWithPolling(userId, platforms, limit = 20, callback) {
        ...
        const subscriptionId = this.subscribeToNotifications(userId, platforms, () => {
...
NotificationService.supabase = createClient(process.env.NEXT_PUBLIC_SUPABASE_URL || '', process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || '');
