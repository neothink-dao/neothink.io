...
PreferencesService.supabase = createClient(
...
NotificationService.supabase = createClient2(
  process.env.NEXT_PUBLIC_SUPABASE_URL || "",
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || ""
);
...
StateSyncService.supabase = createClient3(
  process.env.NEXT_PUBLIC_SUPABASE_URL || "",
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || ""
);
...
var PlatformBridgeContext = createContext(
  void 0
);
...
var PlatformBridgeProvider = ({
  ...
  return /* @__PURE__ */ React.createElement(PlatformBridgeContext.Provider, { value }, children);
};
...
var PlatformSwitcher = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "platform-switcher" }, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    /* @__PURE__ */ React.createElement("option", { value: "hub" }, "Hub"),
    /* @__PURE__ */ React.createElement("option", { value: "immortals" }, "Immortals"),
    /* @__PURE__ */ React.createElement("option", { value: "ascenders" }, "Ascenders"),
    /* @__PURE__ */ React.createElement("option", { value: "neothinkers" }, "Neothinkers")
  ));
};
export {
  navigation_default as NavigationService,
  notifications_default as NotificationService,
  PLATFORM_COLORS,
  PLATFORM_ICONS,
  PLATFORM_NAMES,
  PLATFORM_URLS,
  ...
  PlatformSwitcher,
  preferences_default as PreferencesService,
  state_sync_default as StateSyncService,
  usePlatformBridge
};
