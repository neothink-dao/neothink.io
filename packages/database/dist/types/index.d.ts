...
export declare const __forceTypeExports: import("./types/models").SecurityEvent | import("./types/models").SecurityEventSeverity | import("./types/models").SecurityEventType | import("./types/models").SecurityLog | import("./types/models").PlatformSlug | import("./types/models").AuthState;
