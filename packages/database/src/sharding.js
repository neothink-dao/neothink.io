 ...
 */
export function getShardId(recordId, shardCount) {
 ...
 */
export function getConnectionForRecord(recordId, config) {
 ...
 */
export async function queryAllShards(config, queryFn) {
    const results = [];
    const errors = [];
