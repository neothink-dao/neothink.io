 ...
 */
function createBaseClient(url, key, options = {}) {
    ...
    try {
        return createClient(url, key, Object.assign({ auth: {
 ...
 */
export function getServiceClient(serviceRoleKey) {
    ...
    clientCache[cacheKey] = createClient(supabaseUrl, serviceKey, {
        auth: {
 ...
 */
export function createPlatformClient(platformSlug = 'hub', customOptions = {}) {
    ...
    clientCache[cacheKey] = createBaseClient(supabaseUrl, supabaseAnonKey, Object.assign({ auth: {
            flowType: "pkce",
...
export function createAdminClient() {
    ...
    clientCache[cacheKey] = createClient(supabaseUrl || '', supabaseServiceKey, {
        auth: {
            autoRefreshToken: false,
            persistSession: false
        }
