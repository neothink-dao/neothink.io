...
export type Database = {
  public: {
    ...
    Functions: {
      ...
      can_earn_tokens: {
        Args: { p_user_id: string; p_token_type: string; p_source_type: string }
        Returns: boolean
      }
      check_email_exists: {
        Args: { email: string }
      ...
      check_platform_access: {
        Args: { user_id: string; platform_slug: string }
        Returns: boolean
      }
      ...
      check_user_role: {
        Args: { _user_id: string; _role_slug: string }
        Returns: boolean
      }
      ...
      create_invite: {
        Args: { p_code: string; p_inviter_id: string; p_expires_at: string }
        Returns: string
      }
      create_notification: {
        Args: {
      ...
      generate_tenant_api_key: {
        Args: { _tenant_id: string; _name: string; _scopes?: string[] }
        Returns: Json
      }
      get_activity_interactions: {
        Args: { p_activity_id: string; p_limit?: number; p_offset?: number }
        Returns: {
      ...
      get_personalized_recommendations: {
        Args: { p_user_id: string; p_platform: string; p_limit?: number }
        Returns: {
          content_type: string
          content_id: string
          relevance_score: number
      ...
      get_platform_content: {
        Args: { p_platform: string; include_unpublished?: boolean }
        Returns: {
          module_id: string
          module_title: string
      ...
      get_platform_metrics: {
        Args: { p_platform: string; p_start_date: string; p_end_date: string }
        Returns: {
          metric_key: string
          metric_value: number
      ...
      get_platform_redirect_url: {
        Args: { platform_name: string; redirect_type: string }
        Returns: string
      }
      ...
      get_recent_posts: {
        Args: { p_visibility?: string; p_limit?: number; p_offset?: number }
        Returns: {
          id: string
          author_id: string
          content: string
      ...
      get_role_capabilities: {
        Args: { _role_slug: string; _feature_name: string; _tenant_id: string }
        Returns: {
          can_view: boolean
          can_create: boolean
          can_edit: boolean
      ...
      get_tenant_analytics: {
        Args: { _tenant_id: string; _start_date?: string; _end_date?: string }
        Returns: Json
      }
      get_tenant_by_slug: {
        Args: { _slug: string }
      ...
      get_user_permissions: {
        Args: { _user_id: string; _tenant_slug?: string }
        Returns: {
      ...
      has_platform_access: {
        Args: { platform_slug_param: string }
        Returns: boolean
      }
      hnsw_bit_support: {
        Args: { "": unknown }
      ...
      map_points_to_tokens: {
        Args: { p_user_id: string; p_token_type: string; p_amount: number }
        Returns: undefined
      }
      ...
      migrate_platform_to_tenant: {
        Args: { _platform: string; _admin_user_id?: string }
        Returns: Json
      }
      ...
      process_sunday_zoom_rewards: {
        Args: { p_meeting_id: string; p_minimum_duration?: number }
        Returns: number
      }
      ...
      publish_module: {
        Args: { content_id: string; publisher_id: string }
        Returns: boolean
      }
      record_audit_log: {
        Args: {
      ...
      record_zoom_attendance: {
        Args: { p_user_id: string; p_meeting_id: string; p_join_time?: string }
        Returns: string
      }
      ...
      update_user_platform_for_testing: {
        Args: { p_user_id: string; platform_name: string }
        Returns: string
      }
      ...
      update_zoom_attendance: {
        Args: { p_attendance_id: string; p_leave_time?: string }
        Returns: undefined
      }
      ...
      user_has_platform_access: {
        Args: { _user_id: string; _platform_slug: string }
        Returns: boolean
      }
      validate_schema: {
        Args: Record<PropertyKey, never>
