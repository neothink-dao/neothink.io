...
import type { PlatformSlug } from './types/models';
...
// Explicitly re-export types and functions for downstream consumers
...
// Explicitly export SecurityEvent, SecurityEventSeverity, SecurityEventType, and SecurityEventTypes for downstream usage
