...
export function handleError(error) {
    ...
    if ((error === null || error === void 0 ? void 0 : error.code) && typeof error.code === 'string') {
        return handleDatabaseError(error);
    }
    // Handle already formatted ApiError
    if ((error === null || error === void 0 ? void 0 : error.code) && typeof error.code === 'string' && error.message) {
        return error;
    }
    ...
    return {
        code: ErrorCode.UNKNOWN_ERROR,
        message: 'An unknown error occurred',
        details: typeof error === 'object' ? Object.assign({}, error) : { error }
    };
}
/**
...
function cleanErrorDetails(details) {
    ...
    if (typeof details === 'object') {
        const cleaned = Object.assign({}, details);
