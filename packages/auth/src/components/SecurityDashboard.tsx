...
import { SecurityEventSeverity } from '../utils/securityLogging';
 ...
 */
export default function SecurityDashboard({ platformSlug, limit = 100 }: SecurityDashboardProps) {
  ...
  useEffect(() => {
    async function fetchLogs() {
      ...
      try {
        const supabase = createClient(platformSlug as any);
