...
// Simple type for platform slugs
type PlatformSlug = 'hub' | 'ascenders' | 'immortals' | 'neothinkers';
 ...
 */
export function useSupabaseAuth(platformSlug: PlatformSlug = 'hub') {
  ...
  const signUp = useCallback(
    async (email: string, password: string, metadata = {}): Promise<AuthResponse> => {
      setLoading(true);
      try {
 ...
 */
export function usePlatformAccess(platformSlug: PlatformSlug = 'hub') {
