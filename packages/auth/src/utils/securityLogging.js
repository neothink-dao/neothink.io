 ...
 */
export async function logSecurityEvent(supabase, event) {
    try {
        const { error } = await supabase
            .from('security_events')
            .insert(Object.assign(Object.assign({}, event), { created_at: new Date().toISOString() }));
        if (error) {
...
//# sourceMappingURL=securityLogging.js.map