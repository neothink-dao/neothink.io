...
describe('Security Middleware', () => {
  ...
  beforeEach(() => {
    ...
    mockRequest = new Request('https://hub.neothink.com/api/test') as NextRequest;
  ...
  describe('Suspicious Activity Detection', () => {
    it('should detect SQL injection attempts', async () => {
      const sqlRequest = new Request('https://hub.neothink.com/api/test?q=1%27%20OR%201=1--') as NextRequest;
    ...
    it('should detect XSS attempts', async () => {
      const xssRequest = new Request('https://hub.neothink.com/api/test?q=<script>alert(1)</script>') as NextRequest;
    ...
    it('should detect path traversal attempts', async () => {
      const pathRequest = new Request('https://hub.neothink.com/api/../../../etc/passwd') as NextRequest;
  ...
  describe('Rate Limiting', () => {
    it('should rate limit sensitive endpoints', async () => {
      const authRequest = new Request('https://hub.neothink.com/api/auth/login') as NextRequest;
  ...
  describe('Static Assets', () => {
    it('should skip middleware for static assets', async () => {
      const staticRequest = new Request('https://hub.neothink.com/_next/static/test.js') as NextRequest;
