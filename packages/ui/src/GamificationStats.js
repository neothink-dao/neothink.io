...
export const GamificationStats = ({ stats, isLoading = false, error = null, }) => {
    var _a, _b;
    if (isLoading) {
        return (<Card>
        <CardHeader>
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="flex items-center space-x-2 p-3 bg-secondary/50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">{(_a = stats.points) !== null && _a !== void 0 ? _a : 0}</p>
          </div>
        </div>
        <div className="flex items-center space-x-2 p-3 bg-secondary/50 rounded-lg">
        ...
        <div className="flex items-center space-x-2 p-3 bg-secondary/50 rounded-lg">
          ...
          <div>
            ...
            <p className="text-lg font-semibold">{(_b = stats.streak) !== null && _b !== void 0 ? _b : 0} days</p>
          </div>
        </div>
      </CardContent>
    </Card>);
};
//# sourceMappingURL=GamificationStats.js.map