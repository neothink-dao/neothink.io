...
const SparkCircle: React.FC<SparkCircleProps> = ({
  ...
  return (
    <div
      className={cn(
        'relative w-24 h-24 rounded-full flex items-center justify-center p-2', // Adjust size as needed
        className
      )}
      style={{
    ...
    >
      ...
      <Button
        ...
        className="absolute bottom-1 left-1/2 transform -translate-x-1/2 rounded-full w-10 h-10 p-0" // Small circular button
        style={{ backgroundColor: submitColor }}
        aria-label="Submit Spark"
      >
        {/* Spark Icon or Text */}
