      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            ...
            <RadioGroup value={type} onValueChange={(value) => setType(value)} className="grid grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Tell us what's on your mind..." className="h-32"/>
          </div>
