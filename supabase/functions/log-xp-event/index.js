...
serve(async (req) => {
    ...
    try {
        ...
        const computedMultiplier = multiplier !== null && multiplier !== void 0 ? multiplier : getXPMultiplier(metadata);
        const computedBaseXP = base_xp !== null && base_xp !== void 0 ? base_xp : 10;
        const computedTotalXP = xp_earned !== null && xp_earned !== void 0 ? xp_earned : Math.round(computedBaseXP * computedMultiplier);
        ...
        return new Response(JSON.stringify({ success: true, xpEvent: { user_id, event_type, xp_amount: computedTotalXP }, multiplier: computedMultiplier, newLevel }), { status: 200, headers: { 'Content-Type': 'application/json' } });
    }
    catch (e) {
