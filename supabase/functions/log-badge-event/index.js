...
serve(async (req) => {
    ...
    try {
        ...
        const badgeCriteria = (metadata === null || metadata === void 0 ? void 0 : metadata.criteria) || {};
        const userMeta = (metadata === null || metadata === void 0 ? void 0 : metadata.user_meta) || {};
        if (!isBadgeEligible(metadata === null || metadata === void 0 ? void 0 : metadata.action_type, badgeCriteria, userMeta)) {
        ...
        const badgeEvent = (data === null || data === void 0 ? void 0 : data[0]) || null;
